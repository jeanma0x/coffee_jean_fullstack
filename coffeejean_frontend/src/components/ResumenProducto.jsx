        ...
        <div className="shadow space-y-1 p-4 bg-white">
          ...
          <div className="flex justify-between gap-2 pb-4">
            <button
              ...
              onClick={() => handleEditarCantidad(id)} // Llamamos a la función para editar la cantidad del producto           
            >
              <svg
            ...
            <button
              ...
              onClick={() => handleEliminarProducto(id)} // Llamamos a la función para eliminar el producto del pedido        
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
